...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [alexzia]</title>
        <meta name="description" content="ZkApp By alexzia" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/Alexzia17" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discord.com/channels/@me" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/alexzia" target="_blank" rel="noopener noreferrer" >
